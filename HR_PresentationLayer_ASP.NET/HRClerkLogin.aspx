<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRClerkLogin.aspx.cs" Inherits="HR_PresentationLayer_ASP.NET.HRClerkLogin" %>
    ...
    <div class="nav-wrapper indigo darken-4">
      ...
      <li>
        ...
        <div class="card-action">
          <asp:HyperLink ID="hrlEmployee" runat="server" Text="Login" NavigateUrl="~/EmployeeControl.aspx" ></asp:HyperLink>
